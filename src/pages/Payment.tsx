...
const Payment = () => {
  ...
  const paymentInfo = paymentMethods.find(method => method.id === selectedPaymentMethod);
              ...
              <div className="md:col-span-2">
                <Card className="border-border">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Silakan lengkapi informasi berikut untuk melanjutkan pesanan Anda
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Form {...form}>
                      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Masukkan nama lengkap" {...field} required />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="08xxxxxxxxxx" {...field} required />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                        ...
                        {paymentInfo && (
                          <div className="bg-muted/50 p-4 rounded-lg border border-dashed">
                            <p className="font-medium text-lg">{paymentInfo.name}</p>
                            <p className="mt-1">No. Rekening: <span className="font-mono font-medium">{paymentInfo.accountNumber}</span></p>
                            <p className="mt-1">Atas Nama: <span className="font-medium">{paymentInfo.accountName}</span></p>
                          </div>
                        )}
                          ...
                          render={({ field: { value, onChange, ...field } }) => (
                            <FormItem>
                              ...
                              <p className="text-sm text-muted-foreground">
                                Unggah bukti transfer atau pembayaran Anda (Maks. 2MB)
                              </p>
                              <FormMessage />
                            </FormItem>
                          )}
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      ...
                      <div className="border-t pt-4">
                        ...
                        <p className="font-bold text-2xl text-primary">{packagePrice}</p>
                      </div>
                    </div>
                  </CardContent>
            ...
            {orderDetails && (
              <div className="space-y-4">
                <div className="bg-primary/10 p-4 rounded-lg border border-primary/30">
                  <p className="text-center font-medium">No. Pesanan: <span className="font-bold">{orderDetails.orderNumber}</span></p>
                </div>
